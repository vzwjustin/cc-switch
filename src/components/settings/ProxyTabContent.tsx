...
import { Server, Activity, Zap, Globe, ShieldAlert, Sparkles } from "lucide-react";
...
import { AgentToolsConfigPanel } from "@/components/settings/AgentToolsConfigPanel";
        ...
        >
          <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-muted/50 data-[state=open]:bg-muted/50">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h3 className="text-base font-semibold">
                  {t("settings.advanced.agentTools.title")}
                </h3>
                <p className="text-sm text-muted-foreground font-normal">
                  {t("settings.advanced.agentTools.description")}
                </p>
              </div>
            </div>
          </AccordionTrigger>
          <AccordionContent className="px-6 pb-6 pt-4 border-t border-border/50">
            <AgentToolsConfigPanel />
          </AccordionContent>
        </AccordionItem>
